...
def handle_outliers(df):
    print("Mean value of Available Extra Rooms in Hospital",df['Available Extra Rooms in Hospital'].mean())
    print("Std value of Available Extra Rooms in Hospital",df['Available Extra Rooms in Hospital'].std())
    print("Min value of Available Extra Rooms in Hospital",df['Available Extra Rooms in Hospital'].min())
    print("Max value of Available Extra Rooms in Hospital",df['Available Extra Rooms in Hospital'].max())
    print("Mean value of Visitors with Patient ",df['Visitors with Patient'].mean())
    print("Std value of Visitors with Patient",df['Visitors with Patient'].std())
    print("Min value of Visitors with Patient",df['Visitors with Patient'].min())
    print("Max value of Visitors with Patient",df['Visitors with Patient'].max())
    print("Mean value of Admission_Deposit",df['Admission_Deposit'].mean())
    print("Std value of Admission_Deposit",df['Admission_Deposit'].std())
    print("Min value of Admission_Deposit",df['Admission_Deposit'].min())
    print("Max value of Admission_Deposit",df['Admission_Deposit'].max())

    rooms1=df['Available Extra Rooms in Hospital'].mean()-(df['Available Extra Rooms in Hospital'].std()*3)
    rooms2=df['Available Extra Rooms in Hospital'].mean()+(df['Available Extra Rooms in Hospital'].std()*3)
    df = df[(df['Available Extra Rooms in Hospital'] < rooms2) & (df['Available Extra Rooms in Hospital'] > rooms1)]

    visitors1=df['Visitors with Patient'].mean()-(df['Visitors with Patient'].std()*3)
    visitors2=df['Visitors with Patient'].mean()+(df['Visitors with Patient'].std()*3)
    df = df[(df['Visitors with Patient'] < visitors2) & (df['Visitors with Patient'] > visitors1)]

    visitors1=df['Admission_Deposit'].mean()-(df['Admission_Deposit'].std()*3)
    visitors2=df['Admission_Deposit'].mean()+(df['Admission_Deposit'].std()*3)
    df = df[(df['Admission_Deposit'] < visitors2) & (df['Admission_Deposit'] > visitors1)]
...
train_df = prepare_data_task3(train_df)
test_df = prepare_data_task3(test_df)


# In[7]:


train_df.drop(['case_id'], axis=1, inplace=True)
